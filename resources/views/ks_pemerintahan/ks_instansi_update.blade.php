...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">@lang('general.edit_data_kerjasama_instansi_pemerintahan')</h1>

        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">@lang('general.edit_data_kerjasama_instansi_pemerintahan')</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('pemerintahan.update_proses', $kerjasama->ksId) }}" method="POST" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea type="text" class="form-control" id="ksIsiKS"  rows="5" name="ksIsiKS"
                            >{{ old('ksIsiKS') ?? $kerjasama->ksIsiKS }}</textarea>
                            @error('ksIsiKS')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
