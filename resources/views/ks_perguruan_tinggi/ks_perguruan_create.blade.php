    ...
    <div class="container-fluid mt-4">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">@lang('general.form_tambah_data_perguruan_tinggi')</h6>
            </div>
            <div class="card-body">
        <form action=" {{ route('perguruan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-sm-10">
                <select class="form-control" aria-label="Default select example" id="ksInstansi" name="ksInstansi" value="{{ old('ksInstansi') }}" >
                    ...
                    <option value="PERGURUAN TINGGI" selected {{ old('ksInstansi')=='PERGURUAN TINGGI' ? 'selected': '' }}>PERGURUAN TINGGI</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" rows="5" id="ksIsiKS" name="ksIsiKS" placeholder="Tuliskan Isi Kerjasama" value="{{ old('ksIsiKS') }}"></textarea>
                    @error('ksIsiKS')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
