...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">@lang('general.edit_data_kerjasama_perusahaan_swasta')</h1>

        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">@lang('general.edit_data_kerjasama_perusahaan_swasta')</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('perusahaan.update_proses', $kerjasama->ksId) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        <label for="ksInstansi" class="col-sm-2 col-form-label">@lang('general.perusahaan_swasta')</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="ksIsiKS" rows="5" name="ksIsiKS" >{{ old('ksIsiKS') ?? $kerjasama->ksIsiKS }}</textarea>
                            @error('ksIsiKS')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
