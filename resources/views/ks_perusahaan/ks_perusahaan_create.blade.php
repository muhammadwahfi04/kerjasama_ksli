    ...
    <div class="container-fluid mt-4">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">@lang('general.form_tambah_data_perusahaan_swasta')</h6>
            </div>
            <div class="card-body">
        <form action=" {{ route('perusahaan.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-sm-10">
                <select class="form-control" aria-label="Default select example" id="ksInstansi" name="ksInstansi" value="{{ old('ksInstansi') }}" >
                    ...
                    <option value="PERUSAHAAN/SWASTA" selected {{ old('ksInstansi')=='PERUSAHAAN/SWASTA' ? 'selected': '' }}>PERUSAHAAN/SWASTA</option>
                </select>
            @error('ksInstansi')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" id="ksIsiKS" name="ksIsiKS" placeholder="Tulisakan Isi Kerjasama" rows="5" value="{{ old('ksIsiKS') }}"></textarea>
                    @error('ksIsiKS')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
